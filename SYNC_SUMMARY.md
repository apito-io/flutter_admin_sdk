...
**Package:** `flutter_admin_sdk` (v0.5.0)  
**Aligned with:** `js-admin-sdk` v3.7.0, `go-admin-sdk` v2.6.0
...
- Added **auth/admin** GraphQL: `generateTenantToken`, `loginUser`, `googleOAuthState`, `searchUsers`, `searchTenantsByDomain`, `createUser`, `updateUser`, `resetUserPassword`, `deleteUser`
